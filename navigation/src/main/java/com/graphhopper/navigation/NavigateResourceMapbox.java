 ...
 * The user of this endpoint is: mapbox
 *
 * @author Robin Boldt
 */
@Path("navigate/directions/v5/mapbox")
public class NavigateResourceMapbox {

    private static final Logger logger = LoggerFactory.getLogger(NavigateResourceMapbox.class);
    ...
    @Inject
    public NavigateResourceMapbox(GraphHopper graphHopper, TranslationMap translationMap, GraphHopperConfig config) {
    ...
    private List<GHPoint> getPointsFromRequest(HttpServletRequest httpServletRequest, String profile) {
        ...
        String urlStart = "/navigate/directions/v5/mapbox/" + profile + "/";
