...
public class ArrayUtil {
    ...
    /**
     * Creates an IntArrayList of a given size where each element is set to the
     * given value
     */
    ...
    /**
     * Creates an IntArrayList filled with a permutation of the numbers
     * 0,1,2,...,size-1
     */
    ...
    /**
     * Removes all duplicate elements of the given array in the range [0, end[
     * in place
     *
     * @return the size of the new range that contains no duplicates (smaller or
     * equal to end).
     */
    ...
    /**
     * Creates a copy of the given list where all consecutive duplicates are
     * removed
     */
    ...
    /**
     * Maps one array using another, i.e. every element arr[x] is replaced by
     * map[arr[x]]
     */
    ...
    /**
     * This method calculates the sort order of the first {@param length}
     * element-pairs given by two arrays. The order is chosen such that it sorts
     * the element-pairs first by the first and second by the second array. The
     * input arrays are not manipulated by this method.
     *
     * @param length must not be larger than either of the two input array
     * lengths.
     * @return an array x of length {@param length}. e.g. if this method returns
     * x = {2, 0, 1} it means that that the element-pair with index 2 comes
     * first in the order and so on
     */
    ...
    /**
     * Creates a copy of the given array such that it is ordered by the given
     * order. The order can be shorter or equal, but not longer than the array.
     */
    ...
    /**
     * Creates a new array where each element represents the index position of
     * this element in the given array or is set to -1 if this element does not
     * appear in the input array. None of the elements of the input array may be
     * equal or larger than the arrays length.
     */
     ...
     * @return sorted array consisting of the elements of a and b, duplicates
     * get removed
     */
